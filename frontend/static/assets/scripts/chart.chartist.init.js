	...
	ChartistChart = {
		...
		line: function(){
			new Chartist.Line('#line-chartist-chart', {
					labels: ['Melbourne', 'Inner Melbourne', 'Inner East Melbourne', 'North East Melbourne ' ,' Inner South Melbourne',
						     'North West Melbourne','Outer East Melbourne' ,'South East Melbourne' ,'West Mornington Peninsula'],
					series: [
						[76349.0,76902.0 ,77958.0 ,56915.0,53652.0 ,55815.0, 51562.0 ,53989.0 ,54752.0],
                        [72.77,95.31 ,88.04 ,126.48 ,133.02 ,124.37 ,130.37, 133.84, 137.13]]
				}, {
					fullWidth: true,
					axisY: {
						offset: 10
