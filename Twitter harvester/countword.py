def gettext(tweet):
    txt = tweet.lower()
    for ch in '!"$&()*+,-./:;<=>?@[\\]^_{|}·~‘’':
        txt = tweet.replace(ch, "")
    return txt


def countword(df):
    file1 = df.tweet.dropna(how='any')

    text1 = ''.join(i for i in file1)

    text = re.sub(re.compile('，|；|\.|、|。|“|”|：|！|;|!|&|-'), '', text1)

    txt = gettext(text)

    remove_words = ["|", "1", "2", "3", "4", "@", "part", "You", "lot", "buying", "continue", "change", "It's", "100%",
                    "doesnt", "Not", "Thank", "If", "felt", "-", "wear", "work", "day", "stay", "month", "made", "buy",
                    "days", "period", "found", "feel", "time", "I've", "bit", "didnt", "Very", "give", "find", "thing",
                    "feels", "decided", "thought", "dont", "Im", "I", "They", "The", "These", "Rael", "a", "It", "I'm",
                    "Ive", "This", "So", "No", "My", "But", "didnt""a", "a's", "able", "about", "above", "according",
                    ...
                    "from", "further", "furthermore", "g", "get", "gets", "getting", "given", "gives", "go", "goes",
                    ...
                    "it's", "its", "itself", "j", "just", "k", "keep", "keeps", "kept", "know", "known", "knows", "l",
                    "last", "lately", "later", "latter", "latterly", "least", "less", "lest", "let", "let's", "like",
                    "liked", "likely", "little", "look", "looking", "looks", "ltd", "m", "mainly", "many", "may",
                    ...
                    "nor", "normally", "not", "nothing", "novel", "now", "nowhere", "o", "obviously", "of", "off",
                    ...
                    "uses", "using", "usually", "uucp", "v", "value", "various", "very", "via", "viz", "vs", "w",
                    ...
                    "willing", "wish", "with", "within", "without", "won't", "wonder", "would", "wouldn't", "x", "y",
